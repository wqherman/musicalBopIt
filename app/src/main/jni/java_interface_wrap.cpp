...
SWIGEXPORT jfloat JNICALL Java_com_grame_dsp_1faust_dsp_1faustJNI_getRecordingBuffer(JNIEnv *jenv, jclass jcls, jint jarg1) {
  jfloat jresult = 0 ;
  int arg1 ;
  float result;
  ...
  (void)jcls;
  arg1 = (int)jarg1; 
  result = (float)getRecordingBuffer(arg1);
  jresult = (jfloat)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_com_grame_dsp_1faust_dsp_1faustJNI_setDownloadBuffer(JNIEnv *jenv, jclass jcls, jfloat jarg1, jint jarg2) {
  float arg1 ;
  int arg2 ;
